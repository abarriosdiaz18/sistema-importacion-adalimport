...
# ══════════════════════════════════════════════════════════════════════════════
# _render_estudio_visual — Función reutilizable para ambos modos
# Se define aquí (antes de su uso en el bloque masivo) porque Python ejecuta
# el módulo de arriba a abajo; las llamadas anteriores están dentro de bloques
# condicionales que se evalúan DESPUÉS de que esta función ya fue definida.
# ══════════════════════════════════════════════════════════════════════════════
def _render_estudio_visual(
    ...
    """
    Renderiza el Estudio Visual completo: sube 1 foto → genera 3 formatos.

    Modos:
      individual — usa nombre_producto y precio_producto directamente.
                   Sin selector de productos (modo manual / producto único).
    ...
    with st.expander("🎨  Estudio Visual · ML · Instagram Post · IG Story", expanded=False):
        ...
        # Sufijo único por modo para evitar conflictos de key entre instancias
        _key_sfx = modo
        ...
        # Mostrar producto activo con precio
        st.markdown(
