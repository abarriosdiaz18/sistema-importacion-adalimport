...
# ══════════════════════════════════════════════════════════════════════════════
#  ADALIMPORT — _lote.py  (Orquestador)
#  Responsabilidad única: importar y ejecutar los 3 submódulos en orden.
...
#
#  Comunicación entre módulos: EXCLUSIVAMENTE via st.session_state
